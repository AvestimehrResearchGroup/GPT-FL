"""
The cifar10 dataloader is a modified version of data_loader.py
https://github.com/FedML-AI/FedML/blob/master/python/fedml/data/cifar10/data_loader.py

We changed the output elements in load_partition_data_distributed_cifar10 function
"""
...
from .dataset import CIFAR10_truncated
